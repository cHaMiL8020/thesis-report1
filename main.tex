...
\chapter{Methodology: The dCeNN-ELM-ASP Framework}
\label{sec:methods}
\input{chapter4}

\chapter{Experimental Design \& Data Engineering}
...
\chapter{Results \& Comparative Analysis}
\label{sec:results}
\input{chapter7}
