...
\begin{itemize}
    ...
    \item[-] I have fully and truthfully declared the use of generative models (Artificial Intelligence, e.g. ChatGPT, Grammarly Go, Gemini) including the product version,
...
\centering{
\begin{tabular}{ll}
Chamil Abeysekara m.p.\qquad \qquad \qquad & \qquad \qquad Klagenfurt, \today
\end{tabular}
}
\end{table}
