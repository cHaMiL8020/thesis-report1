...
\begin{itemize}
    ...
    \item[-] I have fully and truthfully declared the use of generative models (Artificial Intelligence, e.g. ChatGPT, Grammarly, Gemini) including the product version,
