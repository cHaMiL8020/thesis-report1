...
This thesis implements an end-to-end neuro-symbolic anomaly detection pipeline for hourly Austrian electricity-market and grid data under weather uncertainty. At a high level, the framework transforms heterogeneous raw observations into increasingly structured representations \cite{repo_readme_framework}:
\FloatBarrier
\begin{figure}[H]
	\centering
